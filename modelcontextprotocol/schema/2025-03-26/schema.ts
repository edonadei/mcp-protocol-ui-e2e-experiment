...
export interface ClientCapabilities {
  ...
  ui?: {
     ...
     */
    supportedComponents?: UIComponentType[];
    /**
     ...
     */
    platforms?: Array<"web" | "mobile" | "desktop" | "terminal">;
    /**
     ...
     */
    interactions?: Array<"mouse" | "touch" | "keyboard" | "voice">;
  };
}
...
export interface PromptMessage {
  role: Role;
  content: TextContent | ImageContent | AudioContent | UIContent | EmbeddedResource;
}
...
export interface SamplingMessage {
  role: Role;
  content: TextContent | ImageContent | AudioContent | UIContent;
}
 ...
 */
export interface ListUITemplatesRequest extends PaginatedRequest {
 ...
 */
export interface ListUITemplatesResult extends PaginatedResult {
 ...
 */
export interface GetUITemplateRequest extends Request {
  method: "ui/templates/get";
  params: {
    /**
 ...
 */
export interface GetUITemplateResult extends Result {
  template: UITemplate;
}
 ...
 */
export interface RenderUIRequest extends Request {
  method: "ui/render";
  params: {
    /**
    ...
    preferences?: {
       ...
       */
      componentVariants?: { [componentType: string]: string };
    ...
    overrides?: {
       ...
       */
      globalStyles?: { [selector: string]: { [property: string]: string } };
    };
  };
}
 ...
 */
export interface RenderUIResult extends Result {
  /**
 ...
 */
export interface UITemplatesListChangedNotification extends Notification {
  method: "notifications/ui/templates/list_changed";
}

/**
 * Request to validate a UI component against a template.
 */
export interface ValidateUIRequest extends Request {
  method: "ui/validate";
  params: {
    /**
 ...
 */
export interface ValidateUIResult extends Result {
  /**
...
export type ClientNotification =
  ...
  | UITemplatesListChangedNotification;
...
export type ServerResult =
  ...
  | CallToolResult
  | ListToolsResult
  | ListUITemplatesResult
  | GetUITemplateResult
  | RenderUIResult
  | ValidateUIResult
  | GetUIPreferencesResult;

/**
 * Request to set client UI preferences that should be applied to all future UI rendering.
 */
export interface SetUIPreferencesRequest extends Request {
  ...
  params: {
    ...
    preferences: {
       ...
       */
      defaultPlatform?: "web" | "mobile" | "desktop" | "terminal";
 ...
 */
export interface GetUIPreferencesRequest extends Request {
  method: "ui/preferences/get";
}

/**
 * Response containing current UI preferences.
 */
export interface GetUIPreferencesResult extends Result {
  preferences: {
    defaultTheme?: "light" | "dark" | "auto";
    defaultPlatform?: "web" | "mobile" | "desktop" | "terminal";
    colorScheme?: {
